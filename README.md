...
| :---: | :--- | :--- | :--- | :--- |
| **A** | **Agentic AI & Gen AI** | 1. Agentic AI & MCP<br>2. Gen AI, RAG, LLM<br>3. AIOps, LLMops using AWS services<br>4. UI/UX → Streamlit, ReactJS | **1. Agentic AI & MCP**<br>• **Agentic AI:** Autonomous agents that perceive, decide, and act (e.g., RPA, trading bots).<br>• **MCP:** End-to-end framework for orchestration, versioning, A/B testing, and feedback loops.<br><br>**2. Gen AI, RAG, LLM**<br>• **Gen AI:** Models generating text/images/code via massive unsupervised learning.<br>• **RAG:** Enhances LLMs by fetching external knowledge to reduce hallucinations.<br>• **LLM:** Transformer-based models (GPT-4, Llama) fine-tuned for specific tasks.<br><br>**3. AIOps, LLMops (AWS)**<br>• **AIOps:** AI for IT ops (anomaly detection, root-cause analysis).<br>• **LLMops:** Managing LLMs at scale (inference costs, latency).<br>• **AWS:** SageMaker (End-to-end), Lambda (Serverless), CloudWatch (Monitoring).  | 1. **Agentic AI Trip Planner (CrewAI)**<br>&nbsp;&nbsp;• [[Details]](https://github.com/Ratnesh-181998/Agentic-AI-Trip-Planner-CrewAI/blob/main/README.md) • [[Tech Stack]](https://github.com/Ratnesh-181998/Agentic-AI-Trip-Planner-CrewAI/blob/main/requirements.txt) • [[Live Demo]](https://agentic-ai-trip-planner-crewai-ykagvec2ng6raotrdaw6sp.streamlit.app/)<br><br>2. **Universal PDF RAG Chatbot**<br>&nbsp;&nbsp;• [[Details]](https://github.com/Ratnesh-181998/Universal-PDF-RAG-Chatbot/blob/main/README.md) • [[Tech Stack]](https://github.com/Ratnesh-181998/Universal-PDF-RAG-Chatbot/blob/main/requirements.txt) • [[Live Demo]](https://universal-pdf-rag-chatbot-mhsi4ygebe6hmq3ij6d665.streamlit.app/) <br><br>**3.AI-Teaching-Assistant**<br>&nbsp;&nbsp;• [[Details]](https://github.com/Ratnesh-181998/AI-Teaching-Assistant-)<br><br> **4.AI Enterprise Systems ChatGPT**<br>&nbsp;&nbsp;• [[Details]](https://github.com/Ratnesh-181998/AI-Enterprise-System---ChatGPT)<br><br> |
...
| **C** | **Machine Learning** | 1. Maths for ML (Probability, Stats, Algebra, Calculus)<br>2. ML Types (Supervised, Unsupervised, RL, Time Series)<br>3. MLOps + FastAPI + Docker + AWS services | - | **•Time Series & Forecasting**<br>&nbsp;&nbsp;**1.AdEase AI Forecasting Engine** •[[Details]](https://github.com/Ratnesh-181998/AdEase-Time-Series-Analysis)•[[Tech Stack]](https://github.com/Ratnesh-181998/AdEase-Time-Series-Analysis/blob/main/requirements.txt)•[[Live Demo]](https://adease-time-series-analysis-drkta7i8zeotm6ayyasjj8.streamlit.app/)<br><br> **•Recommendation-System**<br>&nbsp;&nbsp;**1.ZeeMovies Movie Recommendation System**•[[Details]](https://github.com/Ratnesh-181998/AI-Powered-Movie-Recommendation-System)•[[Tech Stack]](https://github.com/Ratnesh-181998/AI-Powered-Movie-Recommendation-System/blob/main/backend/requirements.txt)•[[Live Demo]](http://localhost:5173)<br><br> **•Manual Clustering(Unsupervised Clustering -K-means,Hierarchical Clustering)** <br>&nbsp;&nbsp;**1.EdTech Learner Clustering Analysis**•[[Details]](https://github.com/Ratnesh-181998/EdTech-Learner-Clustering-Analysis)•[[Tech Stack]](https://github.com/Ratnesh-181998/EdTech-Learner-Clustering-Analysis/blob/main/requirements.txt)•[[Live Demo]](https://edtech-learner-clustering-analysis-q7cozhkz4zafdrwwul9mpv.streamlit.app/)<br><br> **•Ensemble Learning-Bagging & Boosting,KNN Imputation of Missing Values,Random Forest,XGBoost,Working with an imbalanced dataset**<br>&nbsp;&nbsp;**1.OLA Driver Churn Prediction** •[[Details]](https://github.com/Ratnesh-181998/OLA-Driver-Churn-Prediction-Machine-Learning) •[[Tech Stack]](https://github.com/Ratnesh-181998/OLA-Driver-Churn-Prediction-Machine-Learning/blob/main/requirements.txt) •[[Live Demo]](https://ola-driver-churn-prediction-machine-learning-mmntzrjjgxbadbxd4.streamlit.app/)<br><br> **•Feature Engineering,Logistic Regression, Precision Vs Recall Tradeoff**<br>&nbsp;&nbsp;**1.LoanTap-Credit-Risk-Analysis** •[[Details]](https://github.com/Ratnesh-181998/LoanTap-Credit-Risk-Analysis) •[[Tech Stack]](https://github.com/Ratnesh-181998/LoanTap-Credit-Risk-Analysis/blob/main/requirements.txt) •[[Live Demo]](https://loantap-credit-risk-analysis-bg4puocgrxddcwfx3pg5bu.streamlit.app/)<br><br> **•Exploratory Data Analysis,Linear Regression,Statsmodels**<br>&nbsp;&nbsp;**1.Jamboree Education-Linear Regression,** •[[Details]](https://github.com/Ratnesh-181998/Jamboree-Graduate-Admission-Predictor) •[[Tech Stack]](https://github.com/Ratnesh-181998/Jamboree-Graduate-Admission-Predictor/blob/main/requirements.txt) •[[Live Demo]](https://jamboree-graduate-admission-predictor-4yuy3yewzwvlswr2zthnr7.streamlit.app/)<br><br> **•Feature Creation,Relationship between Features,Column Normalization/Column Standardization,Handling categorical values,Missing values-Outlier treatment/Types of outliers**<br>&nbsp;&nbsp;**1.Delhivery Logistics-Feature Engineering** •[[Details]](https://github.com/Ratnesh-181998/Delhivery-Logistics-Analysis-Dashboard) •[[Tech Stack]](https://github.com/Ratnesh-181998/Delhivery-Logistics-Analysis-Dashboard/blob/main/requirements.txt) •[[Live Demo]](https://delhivery-logistics-analysis-dashboard-bp5ruz5asyrx4yc67j5h4i.streamlit.app/)<br><br> **•Bi-Variate Analysis,2-sample t-test: testing for difference across populations,ANNOVA,Chi-square**<br>&nbsp;&nbsp;**1.Yulu Bike-Hypothesis Testing** •[[Details]](https://github.com/Ratnesh-181998/Yulu-Bike-Sharing-Demand-Analytics) •[[Tech Stack]](https://github.com/Ratnesh-181998/Yulu-Bike-Sharing-Demand-Analytics/blob/main/requirements.txt) •[[Live Demo]](https://yulu-bike-sharing-demand-analytics-hpxhkpd9ilirthx2frxya6.streamlit.app/)<br><br>|
